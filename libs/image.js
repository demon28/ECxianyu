 ...
 */
ImageWrapper.prototype.captureScreen = function () {
    if (imageWrapper == null) {
        return;
    }
    var uuid = imageWrapper.captureScreen();
    if (uuid != null) {
 ...
 */
ImageWrapper.prototype.captureScreenToFile = function (path) {
    if (imageWrapper == null) {
        return;
    }
    return imageWrapper.captureScreenToFile(path);
};
...
ImageWrapper.prototype.toBase64 = function (img) {
    ...
    return imageWrapper.toBase64(img.uuid);
};
/**
 * 剪切图片
 * @param img 图片对象
...
ImageWrapper.prototype.clip = function (img, x, y, w, h) {
    ...
    var x = imageWrapper.clip(img.uuid, x, y, w, h);
    if (x != null) {
        return new AutoImage(javaString2string(x));
    }
    return null;
};
/**
