...
NodeInfo.prototype.toString = function () {
    return "NodeInfo{" +
        ...
        ", bounds=" + (this.bounds != null ? this.bounds.toString() : "") +
        ", visibleBounds=" + (this.visibleBounds != null ? this.visibleBounds.toString() : "") +
        '}';
...
function clearTextField(selectors) {
    if (isAccMode()) {
        acEvent.clearTextField(selectors);
    } else if (isAgentMode()) {
        agentEvent.clearTextField(selectors);
    }
...
function clearTextFieldNodeInfo(nodeinfo) {
    if (isAccMode()) {
        acEvent.clearTextFieldNodeInfo(nodeinfo.nid);
    } else if (isAgentMode()) {
        agentEvent.clearTextFieldNodeInfo(nodeinfo.nid);
    }
}
